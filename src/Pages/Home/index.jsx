        ...
        return (
            <Space direction="vertical" style={{width: '100%'}} size={[0, 48]}>
                <Layout style={{minHeight: '100vh'}}>
                    ...
                    <Layout>
                        <Header style={{backgroundColor: '#409eff'}}>
                            <Row style={{height: '100%'}}>
                                ...
                                <Col span={12} style={{display: 'flex', justifyContent: 'end', alignItems: "center"}}>
                                    <Button onClick={logOutClick}>退出</Button>
                                </Col>
                            </Row>
                        </Header>
                        <Content style={contentStyle}>
                            <Routes>
                                <Route path="/home/welcome"
                                       element={<Welcome job={textitem[lognum].name} usermsg={usermsg}/>}/>
                        ...
                        <Content style={contentStyle}>
                            <Routes>
                                ...
                                <Route path='/home/promise' element={<Review lognum={lognum}
                                                                             ...
                                                                             getBed={getBed} tabletype={'bed'}
                                                                             columns={columns} tabledata={tabledata}
                                                                             tablepage={tablepage}
                                                                             tabletitle={tabletitle}/>}/>
                                <Route path='/home/apart' element={<ApartTable tableitems={tableitems}
                                                                               openAddDrawer={() => openAddDrawer('apart')}
                                                                               addMsg={textitem[lognum].addmessages.apart}
                                                                               addfun={apartAdd}
                                                                               getApart={getApart} tabletype={'apart'}
                                                                               columns={columns} tabledata={tabledata}
                                                                               tablepage={tablepage}
                                                                               tabletitle={tabletitle}/>}/>

                                <Route path='/home/room' element={<ApartTable tableitems={tableitems}
                                                                              openAddDrawer={() => openAddDrawer('room')}
                                                                              addMsg={textitem[lognum].addmessages.room}
                                                                              addfun={roomAdd}
                                                                              getRoom={getRoom} tabletype={'room'}
                                                                              columns={columns} tabledata={tabledata}
                                                                              tablepage={tablepage}
                                                                              tabletitle={tabletitle}/>}/>

                                <Route path='/home/bed' element={<ApartTable tableitems={tableitems}
                                                                             openAddDrawer={() => openAddDrawer('bed')}
                                                                             addMsg={textitem[lognum].addmessages.bed}
                                                                             addfun={bedAdd}
                                                                             getBed={getBed} tabletype={'bed'}
                                                                             columns={columns} tabledata={tabledata}
                                                                             tablepage={tablepage}
                        ...
                        <Content style={contentStyle}>
                            <Routes>
                                ...
                                <Route path='/home/paylist' element={<PayTable tableitems={tableitems}
                                                                               getOutPay={getOutPay} tabletype={'bed'}
                                                                               columns={columns} tabledata={tabledata}
                                                                               tablepage={tablepage}
                                                                               tabletitle={tabletitle}/>}/>
